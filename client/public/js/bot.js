...
// const API_URL = "https://d21.vvelocity.com/";
// const PATH = "https://chatbot.vvelocity.com/client/";
const DEFAULT_LOGO = PATH + "images/default.jpg";
const DEFAULT_BTN_IMG = PATH + "images/default_btn.gif";
const CLIENT_IMG = PATH + "images/customer.png";
const POWERED_BY_LOGO = PATH + "images/powerd_by.png";

window.onload = async () => {
  const api_key = document.querySelector("#vvelocity_id").dataset["id"];
  const cId = document.querySelector("#vvelocity_id").dataset["cid"];
  ...
  try {
    response = await callChatBotAPI(
      `${API_URL}chat/questions/${api_key}/${cId}`,
      "GET"
    );
  } catch (err) {
    console.log(err);
